...
import top.ann.zhgy.admin.template.config.properties.WebAuthFilterProperties;
import top.ann.zhgy.admin.template.config.web.convert.BooleanToBaseEnumConverterFactory;
import top.ann.zhgy.admin.template.config.web.convert.IntegerToBaseEnumConverterFactory;
import top.ann.zhgy.admin.template.config.web.convert.StringToBaseEnumConverterFactory;
import top.ann.zhgy.admin.template.web.filter.AuthenticateFilter;
import top.ann.zhgy.admin.template.web.filter.LogAndExceptionHandleFilter;
...
public class CommonUtilWebConfiguration implements WebMvcConfigurer {
    @Override
